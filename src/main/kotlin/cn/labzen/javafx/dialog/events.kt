...
class DialogElementEvent(eventType: EventType<out Event>) : Event(eventType) {
  ...
  companion object {
    val OPENED_TYPE = EventType<DialogElementEvent>("LABZEN_DIALOG_ELEMENT_OPENED")
    val OPENED_EVENT = DialogElementEvent(OPENED_TYPE)
    val CLOSED_TYPE = EventType<DialogElementEvent>("LABZEN_DIALOG_ELEMENT_CLOSED")
...
class DialogWindowEvent(eventType: EventType<out Event>) : Event(eventType) {
  ...
  companion object {
    val OPENED_TYPE = EventType<DialogWindowEvent>("LABZEN_DIALOG_WINDOW_OPENED")
    val OPENED_EVENT = DialogWindowEvent(OPENED_TYPE)
    val CLOSED_TYPE = EventType<DialogWindowEvent>("LABZEN_DIALOG_WINDOW_CLOSED")
